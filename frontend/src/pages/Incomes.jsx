    ...
    <div className="animate-in fade-in duration-500">
      <div className="flex justify-between items-center mb-8">
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-blue-500 hover:bg- text-white px-5 py-2.5 rounded-xl font-medium transition-all duration-200 shadow-sm shadow-indigo-200"
        >
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="pt-2 flex gap-3">
                ...
                <button type="submit" className="flex-1 px-4 py-2.5 text-white bg-blue-500 hover:bg- rounded-xl font-medium transition-colors">Simpan</button>
              </div>
            </form>
          </div>
        </div>
